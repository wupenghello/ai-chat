...
describe('MessageBubble 编辑（REQ-015，iter-4 T2）', () => {
  it('用户消息有编辑入口，点击进入编辑态并回填原文本', async () => {
    ...
    expect(wrapper.find('.edit-trigger').exists()).toBe(true)
