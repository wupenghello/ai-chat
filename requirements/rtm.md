...
> 需求已基线（req-baseline-v1，2026-08-15 CEO 批准）。iter-1 已关闭（G4 过，v0.1.0 已发布）。iter-2 已关闭（2026-08-15，G4 过：开发 T0~T4 全完成、37/37 测试、24 条走查、QA 审计 3 NCR 全整改、复盘完成，见 retros/iter-2.md）。iter-3 计划已批准（Σ9，REQ-009/011/012/013，2026-08-15 CEO 确认，见 plans/iter-3.md）。
...
| REQ-009 | 会话自动命名 | P1 | 待设计师产出 | - | - | 未开始（已排 iter-3，CEO 拍板首选） | iter-3（计划） |
...
| REQ-011 | Markdown 渲染与代码块复制 | P1 | 待设计师产出 | - | - | 未开始（已排 iter-3，含 Markdown 技术选型评估） | iter-3（计划） |
| REQ-012 | 会话重命名 | P2 | 待设计师产出 | - | - | 未开始（已排 iter-3） | iter-3（计划） |
| REQ-013 | 导出会话 | P2 | 待设计师产出 | - | - | 未开始（已排 iter-3） | iter-3（计划） |
